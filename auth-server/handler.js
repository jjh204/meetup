...
const credentials = {
  ...
  redirect_uris: ["https://jjh204.github.io/meetup/"],
  javascript_origins: ["https://jjh204.github.io", "http://localhost:3000", "http://localhost:8080"],
};
...
/**
 *
 * First step in OAuth process is to generate a URL so users can log in with Google and be authorized to see calendar. 
...
module.exports.getAccessToken = async (event) => {
  // the values used to instantiate the OAuthClients are at the top of the file
  const oAuth2Client = new google.auth.OAuth2(
    client_id,
    client_secret,
    redirect_uris[0]
